...
> [!Important]
> This codebase no longer (indirectly) depends on large internal Node.js libraries, making it more suitable for bundling
> in a browser environment or embedding in a small Node.js project once again. [Pre-built browser
> bundles](https://cdn.jsdelivr.net/npm/hawk/dist/) and TypeScript definitions are included.
