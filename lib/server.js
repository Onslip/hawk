...
const B64 = require('./deps/hapi-b64');
const Boom = require('./deps/hapi-boom');
const Cryptiles = require('./deps/hapi-cryptiles');
const Hoek = require('./deps/hapi-hoek');
...
/** @type import('./server').authenticate */
...
/** @type import('./server').authenticatePayload */
...
/** @type import('./server').authenticatePayloadHash */
...
/** @type import('./server').authenticateBewit */
...
/** @type import('./server').authenticateMessage */
